...
const isAuthenticatedAssessor = (req, _, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (error instanceof jsonwebtoken_1.default.TokenExpiredError) {
            return next(new AppError_1.AppError("Token expired", 401, true));
        }
        if (error instanceof jsonwebtoken_1.default.JsonWebTokenError) {
            return next(new AppError_1.AppError("Invalid token", 401, true));
        }
        if (error instanceof jsonwebtoken_1.default.NotBeforeError) {
            return next(new AppError_1.AppError("Token not active", 401, true));
        }
        next(error);
    }
});
