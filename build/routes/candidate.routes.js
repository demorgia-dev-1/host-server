...
router
    ...
    .get(auth_middleware_1.default.isAuthenticatedCandidate, candidate_controller_1.default.getFeedbackForm);
router
    .route("/submit-feedback-form")
    .post(auth_middleware_1.default.isAuthenticatedCandidate, (0, validateRequest_1.default)(candidate_schema_1.submitFeedbackFormSchema), candidate_controller_1.default.submitFeedbackForm);
