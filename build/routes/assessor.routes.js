...
router
    ...
    .get(auth_middleware_1.default.isAuthenticatedAssessor, assessor_controller_1.getPmkyChecklist);
router
    .route("/offline-batches/:batchId/submit-pmky-checklist")
    .post(auth_middleware_1.default.isAuthenticatedAssessor, (0, validateRequest_1.default)(assessor_schema_1.submitPmkyChecklistSchema), assessor_controller_1.submitPmkyChecklist);
router
    .route("/offline-batches/:batchId/upload-pmky-checklist-file")
    .post(auth_middleware_1.default.isAuthenticatedAssessor, assessor_controller_1.uploadPmkyChecklistFiles);
...
router
    ...
    .get(auth_middleware_1.default.isAuthenticatedAssessor, assessor_controller_1.getCandidateListFromMainServer);
router
...
router
    .route("/offline-batches/:batchId/candidates/:candidateId/upload-random-practical-photos")
    .post(auth_middleware_1.default.isAuthenticatedAssessor, assessor_controller_1.default.uploadRandomPhotos);
router
...
router
    .route("/offline-batches/:batchId/candidates/:candidateId/upload-practical-onboarding-files")
    .post(auth_middleware_1.default.isAuthenticatedAssessor, assessor_controller_1.uploadCandidatePracticalOnboadingFiles);
router
